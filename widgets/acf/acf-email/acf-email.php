<?php
/*
Widget Name: ACF Email
Description: Display an ACF email field.
Author: Echelon
*/

class EchelonSOAcfEmail extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'echelonso-acf-email',
            __('ACF Email', $acftt->plugin_text_domain() ),
            array(
                'description' => __('Display an ACF Email field.', $acftt->plugin_text_domain() ),
            ),
            array(
            ...
            array(
                ...
                'email' => array(
                    'type' => 'section',
                    'label' => __( 'Email' , $acftt->plugin_text_domain() ),
                    'hide' => true,
                    'fields' => array(
                        'display_as' => array(
                            'type' => 'radio',
                            'label' => __( 'Display Email As', $acftt->plugin_text_domain() ),
                            'description' =>  __( 'How to display the email address on the page.', $acftt->plugin_text_domain() ),
                            'default' => 'raw_email',
                            'options' => array(
                                'raw_email' => __( 'Raw Email', $acftt->plugin_text_domain() ),
                                'linked_email' => __( 'Linked Email', $acftt->plugin_text_domain() ),
...
siteorigin_widget_register('echelonso-acf-email', __FILE__, 'EchelonSOAcfEmail');
