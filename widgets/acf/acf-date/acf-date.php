<?php
/*
Widget Name: ACF Date
Description: Display an ACF date, date time or time field.
Author: Echelon
*/

class EchelonSOAcfDate extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'echelonso-acf-date',
            __('ACF Date', $acftt->plugin_text_domain() ),
            array(
                'description' => __('Display an ACF date field.', $acftt->plugin_text_domain() ),
            ),
            array(
...
siteorigin_widget_register('echelonso-acf-date', __FILE__, 'EchelonSOAcfDate');
